...
export class Init1676907715938 implements MigrationInterface {
  name = 'Init1676907715938';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "favorites" ("id" integer NOT NULL, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
    // HACK: Create id for all favorites
    await queryRunner.query(`INSERT INTO "favorites" ("id") VALUES (1)`);
